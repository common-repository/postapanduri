 ...
 *
 * @wordpress-plugin
 * Plugin Name:       PostaPanduri
 * Plugin URI:        https://postapanduri.ro/
 * Description:       Courier Services and Smartlocker pickpup. Clients who buy online and can opt to pick up the ordered packages from the nearest preset pickup point or to have the parcel delivered to their door.
 * Version:           2.1.3
 * Author:            C Solution SRL
 * Author URI:        https://www.c-solution.biz/
 * License:           GPL-3.0+
